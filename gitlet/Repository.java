...
public class Repository {
    ...
    public static void commit(String message) {
        ...
        newCommit.setTrackedFiles(HEAD_COMMIT.getTrackedFiles());
    ...
    public static void checkout(String commitSHA) {
        Commit target = Commit.fromFile(commitSHA);

        System.out.println("CHECKOUT TOOOOOO: " + target);

        for (String filename : target.getTrackedFiles().keySet()) {
            System.out.println("Filename: " + filename);
            String blobSHA = target.getTrackedFiles().get(filename);
...
//            Utils.writeContents(file, blob.getContent());
            ...
            System.out.println("Content: " + blob.getContent());
            Utils.writeContents(file, blob.getContent());
        }
